...
const JobCard = ({ job, companyJobs, className }: JobCardProps) => {
  const outsideClass = className || '';

  return (
    <div
      className={`${outsideClass} flex flex-col py-4 px-2 h-full max-h-96 bg-white rounded-lg overflow-y-auto shadow-card`}
    >
      <h2
