<template>
  ...
  <StudentViewTemplate>
    <div class="px-[20%]">
      ...
      <div class="text-left ml-4 flex mt-10">
        <div>
      ...
      <!-- Board -->
      <div class="w-[10/12] bg-[#75B2F5] h-[600px] m-auto rounded-xl grid place-items-center mt-4">
        <div class="w-[98%] bg-[#ffffff] h-[588px] m-auto rounded-xl">
