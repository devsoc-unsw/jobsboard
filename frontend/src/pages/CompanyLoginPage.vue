  ...
  <StudentViewTemplate notLoggedIn>
    <div class="h-full flex flex-col justify-center items-center py-16">
      ...
      <div class="w-4/5 relative group mt-4 mb-6 sm:w-1/2 md:w-2/5 xl:w-1/4">
        <input name="email" id="email" v-model="username" type="text"
          ...
          @keyup.enter="performCompanyLogin()" required />
        <label for="email"
      ...
      <p class="text-lg text-jb-subheadings text-center my-2">
        Not a company?
        <router-link class="text-jb-textlink font-bold transition-colors duration-200 ease-linear 
                        cursor-pointer hover:text-jb-textlink-hovered" to="/login/student">
          Student Login
        </router-link>
      </p>
      <p class="text-lg text-jb-subheadings text-center my-2">
        ...
        <router-link class="text-jb-textlink font-bold transition-colors duration-200 ease-linear 
                        cursor-pointer hover:text-jb-textlink-hovered" to="/company/password-forgot">
          Reset Your Password
        </router-link>
      </p>
      <p class="text-lg text-jb-subheadings text-center my-2 mb-6">
        ...
        <router-link class="text-jb-textlink font-bold transition-colors duration-200 ease-linear 
                        cursor-pointer hover:text-jb-textlink-hovered" to="/signup/company">
          Create one!
        </router-link>
      </p>
