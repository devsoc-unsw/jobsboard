...
>*When developing locally, always remember to change the apiRoot in `frontend/src/config/config.ts` to `localhost`. When ready to submit pr, change back to the production or staging apiRoot*
