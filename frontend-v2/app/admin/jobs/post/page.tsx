...
const AdminJobsPostPage = () => {
  ...
  const submitJobPost = async () => {
    ...
    const res = await api.put(`/admin/company/${selectedCompanyID}/jobs`, {
      headers: {
    ...
    if (res.status === 200) {
      ...
      setAlertMsg('Job posted! This job will be made available to students shortly. Redirecting to the admin account home...')
      setAlertOpen(true)
      window.scrollTo({
        top: 0,
        behavior: 'smooth',
