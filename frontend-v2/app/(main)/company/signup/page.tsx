...
const CompanySignupPage = () => {
  ...
  return (
    <div className='h-full flex flex-col justify-center items-center py-16'>
      <h1 className='font-bold text-3xl text-jb-headings my-4'>
        Company Sign Up
      </h1>
      ...
      {
        !alertOpen && <div
        className='h-full flex flex-col justify-center items-center mb-6'
      >
      ...
      <form className='w-2/5 sm:w-1/2 md:w-2/5 xl:w-1/4'>
        ...
        <div className='relative group mt-4 mb-6'>
          <div
            className='mt-1 flex justify-center rounded-md border-4 border-dashed border-gray-300 hover:bg-gray-100 bg-white px-6 pt-5 pb-6 shadow-btn'
          >
            <div className='space-y-1 text-center'>
              <div className='flex text-sm text-gray-600'>
                ...
                >
                  ...
                  <p className='text-lg font-bold justify-center'>{logo ? logo.name : "Upload logo" }</p>
                </div>}
                  <input
                    id='logo'
                    name='logo'
