...
const CompanyHomePage = () => {
  ...
  return (
    <div>
        ...
        >
          <div className='relative p-4 w-1/2 mx-auto max-w-full'>
            ...
            <div className='relative rounded-lg bg-white'>
              {/* <!-- Modal header --> */}
              <div
                className='flex justify-between items-center p-5 rounded-t border-gray-600'
              >
              ...
              {/* <!-- Modal footer --> */}
              <div
                className='flex flex-row justify-end p-6 space-x-2 rounded-b border-gray-600'
              >
                <button
      ...
      <div className='px-[10%]'>
        <h1
          className='font-bold text-5xl text-jb-headings text-center leading-[72px] m-0 mt-4'
        >
          Welcome Back! &nbsp;👋
        </h1>
