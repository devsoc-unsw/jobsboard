...
const ProfileCard = ({ name, title, involvement, funFact, linkedin, gh, photo}: Props) => {
  return (
    ...
    <div className='pl-5 text-left w-80 h-72'>
      <div className='font-bold text-3xl text-jb-headings mx-4 sm:mx-0 mb-2'>
        {name}
      </div>
      <div className='font-bold text-jb-headings mx-4 sm:mx-0'>
        {title}
      </div>
      <p className='font-bold text-jb-headings mx-4 sm:mx-0 mb-4'>
        {involvement}
      </p>
      <p className='text-lg text-jb-subheadings mx-4 sm:mx-0'>
        {funFact}
      </p>
    </div>
  </div>
