  ...
  return (
    ...
    <div>
      ...
      >
        ...
        <Image
              src={googleLogo}
              className='h-auto max-w-[100px] max-h-[90px] mr-8 self-center' alt='job logo'
        />
        ...
        <div className='sm:flex mx-auto'>
          <button
            className='btn btn-green w-36 h-10 p-2 my-2'
            onClick={approveJob}
          >
            Approve
          </button>
          <button
            className='btn btn-red w-36 h-10 p-2 my-2'
            onClick={rejectJob}
          >
            Reject
          </button>
