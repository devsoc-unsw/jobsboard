  ...
  return (
    ...
    <div className='relative bg-white rounded-lg shadow dark:bg-gray-700 max-h-[80%] my-auto overflow-auto'>
      ...
      <div className='flex items-start flex-col p-6 space-y-6 text-jb-subheadings text-lg text-justify'>
        <p>
          Here at Jobs Board, we pride ourselves on our great work ethic, teamwork and camaraderie. Some of our members have even gone on to work for companies such as Canva and Optiver!
        ...
        <div className='flex w-full justify-center gap-28 py-5'>
          <div>
            <p className='font-bold text-jb-headings text-xl'>
              Frontend
            </p>
        ...
        <p>
          Additionally, if you have prior experience writing unit tests using Jest, end-to-end testing using Cypress, Docker or Kubernetes, that would be a bonus.
        </p>
        <p>
          If you are looking for a frontend role, you are required to complete the Vue Frontend Assessment, which can be found&nbsp;
          <span
        ...
        >
          <p className='font-bold text-center bg-yellow-300 p-3 rounded-md mt-2'>
            Unfortunately, we are not accepting applications at the moment. But don't worry as Projects does rolling recruitment
